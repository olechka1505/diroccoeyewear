...
<div id="main" class="<?php echo esc_attr($modality_theme_options['layout_settings']); ?>">
	<div id="fullpage">
		...
		<div class="section">
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				<div class="world-journal-home padding-0 main-home-video padding-0 youtube row" onclick="thevid=document.getElementById('thevideo'); thevid.style.display='block'; this.style.display='none'; document.getElementById('iframe').src = document.getElementById('iframe').src.replace('autoplay=0','autoplay=1');">
					<li>
...
*/?>
						<i class="fa fa-play mobile"></i>
						<span class="world-journal-thumb"><?php the_post_thumbnail(); ?></span>
						<div class="our-story-desc col-sm-12 col-lg-4">
				...
				<div id="thevideo" style="display: none;"><iframe id="iframe" width="100%" height="92%" src="https://player.vimeo.com/video/154614834?controls=0&showinfo=0&rel=0&autoplay=0" frameborder="0" allowscriptaccess="always" allowfullscreen="true"></iframe></div>
			<?php endwhile; endif; ?>
			<div class="clearfix"></div>
		</div>
		<!-- ./our story -->
